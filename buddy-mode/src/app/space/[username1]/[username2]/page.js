...
export default function ChatPage({ params }) {
    ...
    const getMessageStyle = (sender) => {
        return sender === username1
            ? { container: 'myMessage', type: 'MY' }
            : { container: 'buddyMessage', type: 'BUDDY' };
    };
    ...
    return (
        <div>
            ...
            <div className={styles.bannerText}>
                <div className={styles.bannerText1}>버디 스페이스</div>
                <div className={styles.bannerText2}>나의 버디와 공부하고 추억을 쌓는 공간</div>
            </div>
            <div className={styles.contentContainer}>
                        ...
                        {messages.map((msg, index) => {
                            ...
                            return (
                                <div key={index} className={styles[messageStyle.container]}>
                                    <Chat text={msg.content} styleType={messageStyle.type} />
                                </div>
                            );
                        })}
                    </div>
                ...
                <div className={styles.buddyForestSection}>
                    <div className={styles.buddyForest}>
                        <div className={styles.forestText}>
                            버디 포레스트
                            <Image
                    ...
                    <div className={styles.forestShop}>
                        ...
                        <div className={styles.shopText1}>
                            <Image src="/images/Leaf.png" className={styles.leaf} alt="share" width={13} height={13} />
